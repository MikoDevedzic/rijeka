// SPRINT_4E_1_bootstrap.js
// Writes: backend/pricing/bootstrap.py
// Run from Rijeka root: node SPRINT_4E_1_bootstrap.js
...
const dest = path.join(RIJEKA, 'backend', 'pricing', 'bootstrap.py');
