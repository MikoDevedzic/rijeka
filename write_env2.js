...
const content = `DATABASE_URL=postgresql://postgres.upuewetohnocfshkhafg:Kuracmoj1!@aws-0-eu-central-1.pooler.supabase.com:5432/postgres
...
console.log('✅  .env updated with Session Pooler URL');
