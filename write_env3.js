...
const content = `DATABASE_URL=postgresql://postgres.upuewetohnocfshkhafg:Kuracmoj1!@aws-1-us-east-1.pooler.supabase.com:5432/postgres
...
console.log('✅  .env updated with correct Session Pooler URL');
