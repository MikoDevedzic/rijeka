...
const content = `DATABASE_URL=postgresql://postgres.upuewetohnocfshkhafg:o0UbjD45JnaYOeA1@aws-1-us-east-1.pooler.supabase.com:6543/postgres
...
console.log('✅  .env updated — port changed to 6543');
