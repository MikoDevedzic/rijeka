...
const content = `DATABASE_URL=postgresql://postgres.upuewetohnocfshkhafg:yVgvnUJgDdpVkWlz@aws-1-us-east-1.pooler.supabase.com:5432/postgres
...
console.log('✅  .env updated — port corrected to 5432');
