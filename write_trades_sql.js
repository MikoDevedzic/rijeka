...
write('docs/trades_migration.sql', `-- ============================================================
...
console.log('\n✅  Trades SQL migration written.');
console.log('\nTo apply:');
console.log('  1. Open Supabase Dashboard → Database → SQL Editor');
console.log('  2. New query → paste contents of docs/trades_migration.sql');
console.log('  3. Click Run');
console.log('  4. Verify: should show trades table with 22 columns');
